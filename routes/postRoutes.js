...
//get timeline posts
router.get("/timeline", catchAsync(postController.getTimelinePosts));
router
  .route("/:id")
  .get(catchAsync(postController.getPost))
  .put(catchAsync(postController.updatePost))
  .delete(catchAsync(postController.deletePost));

//like/dislike a post
router.post("/:id/react", catchAsync(postController.postReaction));

//get user's all posts
router.get("/profile/:username", catchAsync(postController.getProfilePosts));

//get post's Likes
router.get("/post-likes/:postId", catchAsync(postController.getPostLikes));
